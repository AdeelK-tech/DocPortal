  ...
  return (
    ...
    <Layout>
      ...
      <div className="constantMargin">
        ...
        <li><span style={{fontSize:"24px"}}><i>Online Tele :</i></span> <a style={{color:"darkblue"}}href= "https://secure.simplepractice.com/practice" target="blank">https://secure.simplepractice.com/clients</a></li>
        <li><span style={{fontSize:"24px"}}><i>In Person :</i></span> 16 Pearl Street Metuchen NJ 08840 <span style={{fontWeight:"bold"}}>( Inexpensive covered and street paid parking available )</span></li>
        <li><span style={{fontSize:"24px"}}><i>Language Spoken :</i></span> English, Spanish (with translation services), Urdu/Hindi </li>
        </ul>
      </div>
        </div>
        <div>
      ...
      <div className="line-break"></div>
        ...
        <div className="Contact" style={{marginTop:"20px"}}>
         <ul className="UnstyledList">
          ...
          <li><span style={{fontSize:"24px"}}><i>Address:</i></span> 16 Pearl Street Metuchen NJ 08840 <span style={{fontWeight:"bold"}}>( Inexpensive covered and street paid parking available )</span></li>
          ...
          <li><span style={{fontSize:"24px"}}><i>Request a free consultation :</i></span> <a style={{color:"darkblue"}} href="https://secure.simplepractice.com/practice" target="blank">https://secure.simplepractice.com/practice</a></li>
         </ul>
